...
class Server:
    ...
    def start(self):
        ...
        server = None
        if self._config.security == Security.NONE.value:
        ...
        elif self._config.security == Security.HTTP_BASIC.value:
            ...
            error("Unknown security mode: {1}. Server is shutting down.".format(self._config.security))
            return
